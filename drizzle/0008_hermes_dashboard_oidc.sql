CREATE TYPE "public"."hermes_dashboard_auth_status" AS ENUM('legacy', 'pending', 'active', 'disabled', 'error');--> statement-breakpoint
CREATE TABLE "jwks" (
...
--> statement-breakpoint
ALTER TABLE "instance" ADD COLUMN "hermes_oidc_client_id" text;--> statement-breakpoint
ALTER TABLE "instance" ADD COLUMN "hermes_dashboard_auth_status" "hermes_dashboard_auth_status" DEFAULT 'legacy' NOT NULL;--> statement-breakpoint
ALTER TABLE "instance" ADD COLUMN "hermes_dashboard_auth_updated_at" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "instance" ADD CONSTRAINT "instance_hermes_oidc_client_id_unique" UNIQUE("hermes_oidc_client_id");--> statement-breakpoint
ALTER TABLE "instance" ADD CONSTRAINT "instance_hermes_oidc_client_id_oauth_client_client_id_fk" FOREIGN KEY ("hermes_oidc_client_id") REFERENCES "public"."oauth_client"("client_id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
