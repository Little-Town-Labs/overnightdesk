...
- **Feature 022 — complete and owner accepted:** PR 85 deployed the shared selected-agent
...
- **Production boundary:** the unified presentation, boundary-aware
  ...
  runtime/OpenRouter tuple is write-only; Walter remains read-only. On
  2026-07-22 the owner accepted the authenticated Overview, Settings, Admin,
  Open Chat, and Titus/Walter Runtime experience.
...
Feature 41 (Export/Import) → COMPLETE
...
- [x] Feature 41: Tenant export/import (engine `9db43de`)
...
Feature 022 is deployed and complete through T050. Authenticated owner
acceptance passed on 2026-07-22. The
