...
- an application-generated UUID inserted explicitly because the parameterized
  Drizzle SQL expression path cannot use Drizzle's TypeScript-only ID default;
